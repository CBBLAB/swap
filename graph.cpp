...
class distNodeGraph
{
	...
	void constructDistNodeGraph(kmerGraph *kGraph, sequence *sequences, parameter *parameters, MPIEnviroment *MPIcontrol);
...
void distNodeGraph::constructDistNodeGraph(kmerGraph *kGraph, sequence *sequences, parameter *parameters, MPIEnviroment *MPIcontrol)
{
	while(kGraph->constructKmerGraph(sequences, parameters, MPIcontrol)!=0)
	{
...
int main (int argc, char *argv[])
{
    ...
    nodeGraph->constructDistNodeGraph(mygraph, sequences, &parameters, &MPIcontrol);
